...
def get_vpc_metadata(account, region, vpc_tags, cidrs):
                ...
                if 'Tags' in vpc:
                    for tag_value in vpc['Tags']:
                        if tag_value['Value'] == tag:
                            ...
                            for route_table in get_default_route_table(returned_vpc,cidrs):
...
def get_default_route_table(returned_vpc,cidrs):
    default_route_table = ''
